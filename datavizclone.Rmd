...
```
This is a neat piece of code that makes a graphic of a desired city based on a handful of inputs- with the main component being GPS data collected through 1 of 4 activities.
It requires two libraries. 
It reads in a .csv with gps route data. 
Does require .csv of gps data.
This would be neat to do with student-volunteered GPS data on campus, or in National Parks or other public spaces.

Source:https://github.com/pveugen/data-visualization
Changes: None

This is the second push to GitHub after burning it down
